        ...
        <div className="md:flex">
          <div className="md:w-1/2 ">
            ...
            <p className="text-2xl  ml-6 mt-4  ">
              ...
              similique repudiandae mollitia excepturi quis tenetur dolor
              commodi a itaque alias ducimus quasi adipisci modi sapiente quos
              saepe odit temporibus, pariatur sequi dignissimos suscipit odio
              error. At?
            </p>
