...
const Cart_Card = ({ image, name, price, category, description, id, qty }) => {
  ...
  return (
    <div className="pl-5 p-2 bg-slate-200">
      <div className="relative md:flex items-center  w-full max-w-4xl bg-white">
        <div className="max-w-sm md:h-[200px] md:w-[200px] overflow-hidden p-1">
